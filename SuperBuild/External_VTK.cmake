...
if(NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR)
  ...
  list(APPEND EXTERNAL_PROJECT_OPTIONAL_ARGS
    ...
    -DVTK_QT_VERSION:STRING=${Slicer_QT_VERSION}
    )
  ...
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_REPOSITORY "github.com/finetjul/VTK.git" CACHE STRING "Repository from which to get VTK" FORCE)
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_TAG "0423c90d1cb9e137ba664b7d6d12cfaffdabbd0b" CACHE STRING "VTK git tag to use" FORCE)
