...
void qMRMLColorTableViewPrivate::init()
{
  ...
  q->horizontalHeader()->setSectionResizeMode(
    qMRMLColorModel::ColorColumn, QHeaderView::ResizeToContents);
  q->horizontalHeader()->setSectionResizeMode(
    qMRMLColorModel::LabelColumn, QHeaderView::Stretch);
  q->horizontalHeader()->setSectionResizeMode(
    qMRMLColorModel::OpacityColumn, QHeaderView::ResizeToContents);
#else
